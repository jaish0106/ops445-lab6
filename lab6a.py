#!/usr/bin/env python3
# Author ID: Anthony J Jayaratnam
...
class Student:
    ...
    def __init__(self, name, number):
        ...
        self.number = str(number)  # Ensure student number is a string
        self.courses = {}
    ...
    def displayGPA(self):
        if len(self.courses) == 0:
            return f"GPA of student {self.name} is 0.0"  # Handle zero division error
